...
import agroSol from "../assets/image/agroSol.webp";
import baraoBarber from "../assets/image/baraoBarber.webp";
import bemNatural from "../assets/image/bemNatural.webp";
import curriculoPro from "../assets/image/curriculoPro.webp";
import holandaSite from "../assets/image/holanda.webp";
import ianeRamos from "../assets/image/ianeRamos.webp";
...
export const technologiesData = {
  ...
  reactnative: {
    imageSrc: "/tech-logos/react-native.svg",
    text: "React Native",
    className: "reactnative-item-list",
  },
  expo: {
    imageSrc: "/tech-logos/expo.svg",
    text: "Expo",
    className: "expo-item-list",
  },
  tauri: {
    imageSrc: "/tech-logos/tauri.svg",
    text: "Tauri",
    className: "tauri-item-list",
  },
  prisma: {
    imageSrc: "/tech-logos/prisma.svg",
    text: "Prisma",
    className: "prisma-item-list",
  },
  whatsapp: {
    imageSrc: "/tech-logos/whatsapp.svg",
    text: "WhatsApp API",
    className: "whatsapp-item-list",
  },
  cloudinary: {
    imageSrc: "/tech-logos/cloudinary.svg",
    text: "Cloudinary",
    className: "cloudinary-item-list",
  },
  tiptap: {
    imageSrc: "/tech-logos/tiptap.svg",
    text: "TipTap",
    className: "tiptap-item-list",
  },
  mercadopago: {
    imageSrc: "/tech-logos/mercadopago.svg",
    text: "Mercado Pago",
    className: "mercadopago-item-list",
  },
  sqlite: {
    imageSrc: "/tech-logos/sqlite.svg",
    text: "SQLite",
  ...
  puppeteer: {
    imageSrc: "/tech-logos/puppeteer.svg",
    text: "Puppeteer",
    className: "puppeteer-item-list",
  },
  swagger: {
    imageSrc: "/tech-logos/swagger.svg",
    text: "Swagger",
    className: "swagger-item-list",
  },
};
  ...
  return [
    {
      ...
      isApi: false,
      categories: ["projetos-independentes", "fullstack", "frontend"] as CategoryKey[],
    },
    {
      id: 2,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      libs: ["sequelize", "swagger", "jwt", "datafns", "winston", "jest", "joi"],
      ...
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend", "fullstack"] as CategoryKey[],
    },
    {
      id: 3,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
    ...
    },
    {
      ...
      isApi: false,
      categories: ["freelancer", "frontend", "landing-pages"] as CategoryKey[],
    },
    {
      id: 6,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      isApi: false,
      categories: ["projetos-proposito", "frontend"] as CategoryKey[],
    },
    {
      id: 7,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      deployUrl: "",
      isApi: true,
      categories: ["projetos-proposito", "backend"] as CategoryKey[],
    },
    {
      id: 8,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      isApi: false,
      categories: ["landing-pages", "frontend"] as CategoryKey[],
    },
    {
      id: 9,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
    ...
    },
    {
      ...
      isApi: false,
      categories: ["projetos-independentes", "frontend"] as CategoryKey[],
    },
    {
      id: 14,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
    ...
    },
    {
      ...
      libs: [],
      infra: [],
      imageClass: "jogoDaVelha",
      buttonClass: "jogoDaVelha",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["primeiros-passos", "desktop"] as CategoryKey[],
    },
    {
      id: 16,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
    ...
    },
    {
      ...
      libs: [],
      infra: [],
      imageClass: "desafioMarketplace",
      buttonClass: "desafioMarketplace",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
    ...
    },
    {
      ...
      stack: t("project.list.22.stack"),
      technologies: ["react", "tauri"],
      libs: [],
      infra: ["vite"],
      imageClass: "testesTauri",
      buttonClass: "testesTauri",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-experimentais", "desktop"] as CategoryKey[],
    },
    {
      id: 24,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
    ...
    },
    {
      ...
      stack: t("project.list.25.stack"),
      technologies: ["nodejs", "express"],
      libs: ["jwt", "sequelize"],
      infra: [],
      imageClass: "authApiBackend",
      buttonClass: "authApiBackend",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-experimentais", "backend"] as CategoryKey[],
    },
    {
      id: 27,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.26.stack"),
      technologies: ["react", "typescript"],
      libs: ["materialui", "formik", "axios"],
      infra: [],
      imageClass: "authApiFrontend",
      buttonClass: "authApiFrontend",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-experimentais", "frontend"] as CategoryKey[],
    },
    {
      id: 28,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      technologies: ["nodejs", "express"],
      libs: ["sequelize", "jwt", "joi", "winston", "jest", "swagger"],
      infra: [],
      imageClass: "sotov",
      buttonClass: "sotov",
      gitHubUrl: "",
    ...
    },
    {
      ...
      stack: t("project.list.28.stack"),
      technologies: ["reactnative", "expo", "typescript"],
      libs: ["sqlite"],
      infra: [],
      imageClass: "appFinanceiro",
      buttonClass: "appFinanceiro",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["em-desenvolvimento", "mobile"] as CategoryKey[],
    },
    {
      id: 30,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.29.stack"),
      technologies: ["reactnative", "expo", "typescript"],
      libs: [],
      infra: [],
      imageClass: "consorcioHonda",
      buttonClass: "consorcioHonda",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "mobile"] as CategoryKey[],
    },
    {
      id: 31,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.30.stack"),
      technologies: ["nodejs", "express"],
      libs: ["sequelize", "jwt", "joi", "winston", "jest", "swagger", "whatsapp"],
      infra: ["postgresql"],
      imageClass: "cardapioOnlineApi",
      buttonClass: "cardapioOnlineApi",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.31.stack"),
      technologies: ["react", "typescript"],
      libs: ["formik", "axios", "notyf", "aos"],
      infra: [],
      imageClass: "taServido",
      buttonClass: "taServido",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "frontend"] as CategoryKey[],
    ...
    },
    {
      ...
      stack: t("project.list.37.stack"),
      technologies: ["nodejs", "express"],
      libs: [],
      infra: ["postgresql"],
      imageClass: "apiClienteSaude",
      buttonClass: "apiClienteSaude",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["freelancer", "backend"] as CategoryKey[],
    },
    {
      id: 39,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.38.stack"),
      technologies: ["reactnative", "expo", "typescript"],
      libs: [],
      infra: [],
      imageClass: "memoriaEVida",
      buttonClass: "memoriaEVida",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["destaques", "freelancer", "mobile"] as CategoryKey[],
    },
    {
      id: 40,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.39.stack"),
      technologies: ["react", "materialui", "typescript"],
      libs: ["mercadopago"],
      infra: [],
      imageClass: "paymentWidget",
      buttonClass: "paymentWidget",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "frontend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.40.stack"),
      technologies: ["nodejs", "express"],
      libs: ["prisma", "jwt", "mercadopago"],
      infra: ["postgresql", "docker"],
      imageClass: "paymentSystemMp",
      buttonClass: "paymentSystemMp",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.41.stack"),
      technologies: [],
      libs: [],
      infra: [],
      imageClass: "leituras",
      buttonClass: "leituras",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes"] as CategoryKey[],
    },
    {
      id: 43,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.42.stack"),
      technologies: ["nodejs", "express"],
      libs: ["prisma", "puppeteer", "cloudinary", "mercadopago"],
      infra: ["postgresql", "vercel"],
      imageClass: "resumeGenPayment",
      buttonClass: "resumeGenPayment",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.43.stack"),
      technologies: ["react", "typescript"],
      libs: [],
      infra: [],
      imageClass: "curriculoPro",
      buttonClass: "curriculoPro",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "frontend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.44.stack"),
      technologies: ["nodejs", "express"],
      libs: ["prisma", "jwt", "cloudinary"],
      infra: ["postgresql", "vercel"],
      imageClass: "futebolHolandesApi",
      buttonClass: "futebolHolandesApi",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.45.stack"),
      technologies: ["react", "typescript"],
      libs: ["tiptap", "cloudinary"],
      infra: ["vite"],
      imageClass: "futebolHolandesFrontend",
      buttonClass: "futebolHolandesFrontend",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "frontend"] as CategoryKey[],
    },
    {
      id: 47,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      imgUrl: ImageUrls.projects.baraoBarber,
      title: t("project.list.46.title"),
      description: t("project.list.46.description"),
      stack: t("project.list.46.stack"),
      technologies: ["react", "typescript"],
      libs: ["aos", "notyf"],
      infra: [],
      imageClass: "baraoBarbearia",
      buttonClass: "baraoBarbearia",
      gitHubUrl: "https://github.com/jefferson-da-silva-santos/barao-barbearia",
      deployUrl: "https://barao-barbearia.netlify.app",
      isApi: false,
      categories: ["freelancer", "frontend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.47.stack"),
      technologies: ["reactnative", "expo", "typescript"],
      libs: ["sqlite"],
      infra: [],
      imageClass: "verbumApp",
      buttonClass: "verbumApp",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-proposito", "mobile"] as CategoryKey[],
    },
    {
      id: 49,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      ...
      stack: t("project.list.48.stack"),
      technologies: ["react", "typescript"],
      libs: ["aos", "notyf"],
      infra: [],
      imageClass: "verbumLanding",
      buttonClass: "verbumLanding",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "frontend", "landing-pages"] as CategoryKey[],
    },
    {
      id: 50,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
    ...
    },
    {
      ...
      stack: t("project.list.50.stack"),
      technologies: ["reactnative", "expo", "typescript"],
      libs: [],
      infra: [],
      imageClass: "propfyApp",
      buttonClass: "propfyApp",
      gitHubUrl: "",
      deployUrl: "",
      isApi: false,
      categories: ["projetos-independentes", "mobile"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.51.stack"),
      technologies: ["nodejs"],
      libs: ["prisma"],
      infra: [],
      imageClass: "propfyApi",
      buttonClass: "propfyApi",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend"] as CategoryKey[],
    },
    {
      ...
      stack: t("project.list.52.stack"),
      technologies: ["nodejs", "express"],
      libs: ["jwt"],
      infra: ["postgresql", "render"],
      imageClass: "blogServerApi",
      buttonClass: "blogServerApi",
      gitHubUrl: "",
      deployUrl: "",
      isApi: true,
      categories: ["projetos-independentes", "backend"] as CategoryKey[],
    },
    {
      ...
      buttonClass: "agroSol",
      gitHubUrl: "",
      deployUrl: "https://seu-site-aqui.netlify.app/agrosol",
      isApi: false,
      categories: ["freelancer", "frontend", "landing-pages"] as CategoryKey[],
    },
    {
      id: 55,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      imgUrl: ImageUrls.projects.bemNatural,
      title: t("project.list.54.title"),
      description: t("project.list.54.description"),
      stack: t("project.list.54.stack"),
      technologies: ["react", "typescript"],
      libs: ["aos", "boxicons", "notyf"],
      infra: ["vite"],
      imageClass: "bemNatural",
      buttonClass: "bemNatural",
      gitHubUrl: "",
      deployUrl: "https://bemnaturallimoeiro.com.br",
      isApi: false,
      categories: ["freelancer", "frontend"] as CategoryKey[],
    },
    {
      id: 56,
      videoUrl: "https://www.youtube.com/watch?v=SEU_ID_AQUI",
      imgUrl: ImageUrls.projects.ianeRamos,
      title: t("project.list.55.title"),
      description: t("project.list.55.description"),
      stack: t("project.list.55.stack"),
      technologies: ["react", "typescript"],
      libs: ["aos", "boxicons", "notyf"],
      infra: [],
      imageClass: "ianeRamos",
      buttonClass: "ianeRamos",
      gitHubUrl: "",
      deployUrl: "https://ianeramospersonal.com.br",
      isApi: false,
      categories: ["freelancer", "frontend", "landing-pages"] as CategoryKey[],
    },
  ];
